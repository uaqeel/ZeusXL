...
{
    /// <summary>
    /// Provides attribute data for Excel registered object methods
    /// </summary>
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = false, Inherited = false)]
    public sealed class ExcelObjectMethodAttribute : Attribute
    {
        ...
        /// </summary>
        public ExcelObjectMethodAttribute() { }

        /// <summary>
        /// Instantiate new ExcelObjectAttribute
        /// </summary>
        /// <param name="Description">Description of objects</param>
        public ExcelObjectMethodAttribute(string Description)
        {
