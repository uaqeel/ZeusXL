...
{
    /// <summary>
    /// Provides attribute data for Excel registered object properties
    /// </summary>
    [AttributeUsage(AttributeTargets.Property, AllowMultiple = false, Inherited = false)]
    public sealed class ExcelObjectPropertyAttribute : Attribute
    {
        ...
        /// </summary>
        public ExcelObjectPropertyAttribute() { }

        /// <summary>
        /// Instantiate new ExcelObjectAttribute
        /// </summary>
        /// <param name="Description">Description of objects</param>
        public ExcelObjectPropertyAttribute(string Description)
        {
